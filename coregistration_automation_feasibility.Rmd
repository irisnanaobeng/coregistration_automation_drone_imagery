---
title: "Feasibility of Drone Multispectral Image Coregistration Automation"
...
setwd("~/Desktop/drone coregistration")

# Load required package for raster processing
library(terra)
```

# Report: Automatic Multispectral Image Coregistration

This document demonstrates the visual assessment of pre-aligned multispectral drone imagery.
It compares the original misaligned bands to the aligned versions using false-color composites.
...
2. Software
R with terra package

   - Multispectral cameras capture different wavelength bands through separate lenses or sensors, creating spatial misalignment between bands.
...
Explanation:
 ...
 - Each other band is shifted pixel-by-pixel to maximize correlation with     Green.
...
The following code visualizes the alignment results by comparing before/after states:
...
- Generates side-by-side false-color composites to compare before and       after alignment.
- Visual inspection confirms improved color consistency and reduced misalignment in the “after” images.
...
This document presents the visualization and assessment of automatic multispectral image co-registration. 
